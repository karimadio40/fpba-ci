...
const Footer: React.FC = () => {
  ...
  const productLabels: string[] = [
    t('products.items.electric.title'),
    t('products.items.telecom.title'),
    t('products.items.lighting.title'),
    t('products.items.fence.title'),
    t('products.items.custom.title'),
    t('products.items.accessories.title'),
  ];
        ...
        <div className="footer__grid">
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              <a href="https://wa.me/2250504019299" target="_blank" rel="noreferrer" className="footer__social" aria-label="WhatsApp">
              ...
              <a href="mailto:n.goue@sibmci.com" className="footer__social" aria-label="Email">
          ...
          <div className="footer__col">
            <h4 className="footer__col-title">{t('footer.products_title')}</h4>
            <ul className="footer__links">
              {productLabels.map((s) => (
                <li key={s}>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__contact-list">
              ...
              <li>
                ...
                <a href="mailto:n.goue@sibmci.com">n.goue@sibmci.com</a>
              </li>
              <li>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="15" height="15">
                ...
                <a href="tel:+2250504019299">+225 05 04 01 92 99</a>
              </li>
            </ul>
          </div>
        </div>
